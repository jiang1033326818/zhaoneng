                        ...
                        <Row className="formTitle">
                            ...
                            <Col span={12}>
                                <Form>
                                    ...
                                    <FormItem label="长协电量" {...formItemLayout}>
                                        {getFieldDecorator('name', {

                                        })(<div className="inputLength2" >{this.state.data.bilateral+"万千瓦时"}</div>)}
                                    </FormItem>
                                    <FormItem label="竞价电量" {...formItemLayout}>
                                        {getFieldDecorator('name', {

                                        })(<div className="inputLength2" >{this.state.data.bidding+"万千瓦时"}</div>)}
                                    </FormItem>
