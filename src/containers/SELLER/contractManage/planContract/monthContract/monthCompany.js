...
export  default class monthCompany extends React.Component {
	...
	handleDetail = (record) => {
		this.props.history.push(`/seller/contractdetail/`+ record.contractId);
	}
	handleTableList = (params) => {
		...
		let url='/api/contract/plan/company/'+ month;
    		...
    		<Content style={{ padding: '0 50px' }}>
				...
				<div style={{ background: '#fff', padding: 24, minHeight: 760 }} className="content">
					...
					<Row className="payList">
						<Row>
							<h3 style={{marginTop:"20px"}}>长期协议统计-企业月度总览</h3>
						</Row>
						<Row>
