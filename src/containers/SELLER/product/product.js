...
export default class Index extends React.Component {
    ...
    onSelectChange = (selectedRowKeys,value) => {
        ...
        console.log(value)
        sessionStorage.setItem('arrvalue',value)
    }
    topay =()=>{
                ...
                <Content style={{padding: '0 50px'}}>
                    ...
                    <div style={{background: '#ffffff', padding: 24, minHeight: 750}} className="contentindex">
                        ...
                        <div className={'footerbtn'}>
                            <Button type="primary"  onClick={this.topay} className={'footerbtn1'}>提交</Button>
                            <Button  className={'footerbtn2'}>取消</Button>
                        </div>
