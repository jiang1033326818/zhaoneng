...
import { Row, Col, Button, Form, Input, InputNumber, Spin, message, Checkbox, Select, Cascader } from 'antd';
...
handleNext = (e) => {
	...
	this.props.form.validateFields((err, value) => {
		if (!err) {
			...
			let url = '/api/company/cid/create';
			let headers = {
							...
							<Row>
								<Col span={12}>
									...
									>
											...
											})(<Input size='default' placeholder='请输入户号' className="inputMeter" />)}
									</FormItem>
									<FormItem label="户名简称" {...formItemLayout}>
										{getFieldDecorator('shortName', {
											initialValue: company,
										})(<Input size='default' placeholder='请输入户名简称' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="用电地址"
									...
									>
										{getFieldDecorator('address', {
											...
											<Cascader options={addressData} placeholder="请选择所属行政区域" className="inputMeter" />
										)}
									</FormItem>
									<FormItem
										{...formItemLayout}
								...
								<Col span={12}>
									<FormItem label="户名" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入户名' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="计量点编号"
										hasFeedback
									>
											{getFieldDecorator('measuring', {
												rules: [
													{ required: true, message: '请输入计量点编号' },
													{
														pattern: /^[a-zA-Z0-9]{6,10}$/,
														message: '请输入正确的计量点编号'
													}
												],
											})(<Input size='default' placeholder='请输入计量点编号' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="用电性质"
									...
									>
										{getFieldDecorator('nature', {
											...
											<Select placeholder="请选择用电性质" className="inputMeter">
												<Option value="工业类用电">工业类用电</Option>
												<Option value="商业服务业类用电">商业服务业类用电</Option>
												<Option value="居民类用电">居民类用电</Option>
												<Option value="类居民用电">类居民用电</Option>
												<Option value="其他类用电">其他类用电</Option>
											</Select>
										)}
									</FormItem>
									<FormItem
									...
									>
										...
										<span className="ant-form-text"> 千瓦时</span>
									</FormItem>
								</Col>
							</Row>
