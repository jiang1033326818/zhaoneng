	...
	this.props.form.validateFields((err, value) => {
		if (!err) {
			const param = {
				...
				"businessAddress": value.businessAddress[0]+'-'+value.businessAddress[1]+'-'+value.businessAddress[2],
				"currency": value.currency,
				"email": value.email,
				"id": Number(sessionStorage.companyId),
				"industryCode": value.industryCode,
				"industryName": value.industryName[0]+'-'+value.industryName[1]+'-'+value.industryName[2],
				"name": value.name,
				"natureCode": value.natureCode,
				"natureName": value.natureName,
				"regionCode": value.regionCode,
				"regionName": value.regionName[0]+'-'+value.regionName[1]+'-'+value.regionName[2],
				"registeredAddress": value.registeredAddress[0]+'-'+value.registeredAddress[1]+'-'+value.registeredAddress[2],
			...
			api.post(url, headers, param,
				(res) => {
					...
					const natureName = value.natureName;
					const type = value.type;
					const industryName = value.industryName;
					this.setState({activeKey: String(newKey)});
					this.props.handleActiveKeyOne(newKey,regionName, type, natureName,industryName);
				},
				(err) => {
					this.setState({spinLoading:false});
...
render() {
	...
	const { industryCategory, company, spinLoading } = this.state;
  return (
								...
								<Col span={12}>
									...
									>
										{getFieldDecorator('regionName', {
											...
											<Cascader options={addressData} placeholder="请选择行政区域" className="inputMeter" />
										)}
									</FormItem>
									<FormItem label="行政区域编码" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入行政区域编码' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="办公地址"
									...
									>
										{getFieldDecorator('businessAddress', {
											rules: [
												{ required: true, message: '请选择所属办公地址' },
											],
										})(
											<Cascader options={addressData} placeholder="请选择所属办公地址" className="inputMeter" />
										)}
									</FormItem>
									<FormItem
										{...formItemLayout}
									...
									>
										{getFieldDecorator('registeredAddress', {
											rules: [
												{ required: true, message: '请选择所属注册地址' },
											],
										})(
											<Cascader options={addressData} placeholder="请选择所属注册地址" className="inputMeter" />
										)}
									</FormItem>
									<FormItem
										{...formItemLayout}
									...
									<FormItem label="企业邮箱" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入邮箱号' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="邮箱是否验证"
									...
									>
										{getFieldDecorator('emailVerified', {
											initialValue: 'true',
											rules: [
												{ required: true, message: '请选择邮箱是否验证' },
											],
										})(
											<Select placeholder="请确认邮箱是否验证" className="inputMeter">
									...
									<FormItem label="企业电话" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入企业电话' className="inputMeter" />)}
									</FormItem>
									<FormItem label="交易中心账号" {...formItemLayout}>
										{getFieldDecorator('centerAccount', {
											initialValue: '',
											rules: [
												{
													required: true,
										...
										})(<Input size='default' placeholder='请输入交易中心账号' className="inputMeter" />)}
									</FormItem>
									<FormItem label="交易中心密码" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入交易中心密码' className="inputMeter" type="password" />)}
									</FormItem>
								</Col>
								<Col span={12}>
									...
									>
										{getFieldDecorator('natureName', {
											initialValue: '',
											rules: [
												{ required: true, message: '请选择企业性质名称' },
											],
										})(
											<Select placeholder="请选择企业性质名称" className="inputMeter">
									...
									<FormItem label="企业性质编码" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入企业性质编码' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="行业分类名称"
									...
									<FormItem label="行业分类编码" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入行业分类编码' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="公司类型"
									...
									>
										{getFieldDecorator('type', {
											...
											<Select placeholder="请选择公司类型" className="inputMeter">
												<Option value="服务业公司">服务业公司</Option>
												<Option value="独资企业">能源公司</Option>
											</Select>
										)}
									</FormItem>
									...
									<FormItem label="纳税人识别码" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入纳税人识别码' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="开户银行"
									...
									>
										{getFieldDecorator('bank', {
											...
											<Select placeholder="请选择开户银行" className="inputMeter">
									...
									<FormItem label="银行账号" {...formItemLayout}>
										...
										})(<Input size='default' placeholder='请输入银行账号' className="inputMeter" />)}
									</FormItem>
									<FormItem
										{...formItemLayout}
										label="注册资本"
