												...
												<Form onSubmit={this.handleSubmit} className="login-form">
													...
													<FormItem>
														{getFieldDecorator('captcha', {
															...
															<Input prefix={<Icon type="mail" style={{ color: 'rgba(0,0,0,.25)' }}  />} key="verificationCode" style={{width: '60%', float: "left"}} placeholder="输入验证码" onChange={this.verificationCode} />
														)}
														<img src={api.basepath+"/api/kaptcha/render"} alt="验证码" className={`maeginButton`} id="code" onClick={this.upDateCode}  />
													</FormItem>
													<FormItem>
														<Input  key="submit" placeholder="获取验证码" type="submit" value="登录"
